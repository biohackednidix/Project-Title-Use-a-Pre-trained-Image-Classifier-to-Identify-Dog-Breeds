...
#            pct_correct_notdogs - percentage of correctly classified NON-dogs
    ...
    ### fix issue-- replace key with value in below code
    for value in results_dic.values():
        if value[2] == 1:  # Labels Match Exactly
            results_stats_dic['n_match'] += 1
        
        if value[3] == 1:  # Pet Image Label is a Dog
            results_stats_dic['n_dogs_img'] += 1
            if value[4] == 1:  # Correctly classified dog images
                results_stats_dic['n_correct_dogs'] += 1
            if value[2] == 1:  # Correct breed for dog images
    ...
    return results_stats_dic ##changes--indent of return