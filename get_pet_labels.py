...
def get_pet_labels(image_dir):
    ...
    ### fix error--- add filename instead of in_files[idx]
    for filename in in_files:
       ...
       if filename[0] != ".":
           ...
           pet_label = filename.lower().rsplit(".", 1)[0].replace("_", " ")
           pet_label = " ".join([word for word in pet_label.split() if word.isalpha()])
